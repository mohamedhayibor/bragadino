// alchemy 0.0.0 > you have to understand ternary variables to be an alchemist
// Write a function that accepts two arguments and returns 
// the remainder after dividing the larger number by the smaller number.
...
// Write a function that takes a string, then swaps the case for each of the letters.
...
// Write a function that takes an array and an item, and returns true
// if the item belongs to the array
...
// Have you ever used .some() in your alchemist gigs? Here's your chance
// Write a function that takes an array and a function then returns true
// if the function returns true for any item in the array
...
// Write a function that takes an array and a function then returns true
// if the function returns true for all item in the array
...
// Write a function that takes a string then outputs an array containing
// all the words and their lengths
...
// reduce is one of the most powerful tools for the alchemist
// Let's dive in. Write a function that takes an array containing numbers
// then returns the sum of the numbers in the array 
...
// More practice on reduce
// Write a function that takes a single word (string) as argument then returns
...
// warming up with map:
// write a function that squareEveryDigit of passed in number
...
// Write a function countVowels that returns
...
// Scaling up: write a function that takes a string and a number (n) that
// returns a string that repeats the initial string (n) number of times.
...
// Sometimes when you're dealing with hundred lines of code if / else ifs... can be
// hard to parse and reason with. You can use ternary conditions to your advantage.

// Write a function that takes a DNA sequence as a string then swap all
// elements to it's complement so that: 'A' -> 'T', 'T' -> 'A'
// 'C' -> 'G' and 'G' -> 'C'
...
// How about we attack objects with our alchemy?
// Write a function that takes an object and generates
...
// 0.0.1 => filter is the alchemist's shotgun
...
// write a function that adds your name or whatever value
// a 1000 times to an array
...
// let's go badass on arguments and arrays
// write a function that sums all numbers passed as arguments
...
// Write a dropCap function that capitalizes the first letter of every word
...
// Alchemy 3.0.0  ===> "get ready to turn dust into gold"
// Write a function that compares each pair of integers (same index) from 2 arrays and
// returns a new array of large numbers. Assumption: Both arrays have the same length
...
// Do you use .every() often, let's take a stab at it
// Write a function that checks if all arguments passed in are numbers
...
// Alchemist 1.0.0: Entering the Alchmist dojo 
// Write a function that a non-negative integer and returns
// an array of the individual digits.
...
// Write a function that takes an array, find the duplicates in that array
// and then returns a new array of unique values of the duplicates.
...
// Your alchemist gigs got you a lot of money, so you decide to invest in a stock
// Write a function to know how much your investment is worth with the given arguments:
...
// Did you know that you could use the index of the array with map, reduce,
// reduceRight, every, filter, some ...
// Well, let's dive in an play with it. Write a function
// such as add(3,4,5); returns 26 => "( 3 * 1 ) + ( 4 * 2 ) + ( 5 * 3 )"
...
/*********************************************************************/
// ignore for now ******************************
// The alchemist adding a new property usersAnswer to every object in the array 
function newPropsInArray(array, property) {
...
console.log(newPropsInArray(questions, 'usersAnswer'));
//==> [{usersAnswer: null}, {usersAnswer: null}, {usersAnswer: null}]

/* --- Deconstruction
* we are looping through all objects in the array
* then creating a new property in each and attaching to it the value null
*/
...
// that will return a list of length (n) with multiples of (x).
// Assumptions: n && x > 0
...
// Write a function that takes an integer as argument and outputs
// a string with currency format. ex: 123456 => "123,456"
...
// How about including recursion into our alchemy?
...
/*********************************************************************/
// Let's have some wild laughs now with our skills
// Write a function, mumbling such as mumbling('abcd') => "A-Bb-Ccc-Dddd",
...
// Write a function that takes a string and returns the same string with the rules:
...
// When you become really good at alchemy, you'll solve problems quickly 
// because of the way you parse them in your mind. let's prove that

// Alchemy and a typical interview question:
...
// I want to draw your attention on an insiduous temptation on nesting functions
// and getting lost in the process. Our goal as an alchemist is to use powerful tools
// that help us solve problems the easiest way possible, rather than causing confusion
// let's make the case with the following exercise:

// Implement a function (same as algorithm) that determines whether a string is an isogram.
...
// Have you ever wrote an encoder? let's create one
// Write a duplicate encoder (function) that takes a word (string) then returns a 
// string composing of "<" if the character is unique or ">" otherwise
...
// Write a global flatten method that takes any number of arguments and flattens them
// into a single array. Any nested arrays, no matter how deep should be flattened
// into the single array result. exple: flatten(3 , ['John', 7], [NaN, 9], [[4], ['c']])
// ===> [ 3, 'John', 7, NaN, 9, 4, 'c' ]
